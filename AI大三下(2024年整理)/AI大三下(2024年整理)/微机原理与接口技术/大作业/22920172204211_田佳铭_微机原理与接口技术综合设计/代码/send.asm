...
CH_PORT MACRO NP_8255A,T_8255A,NP_8253,T_8253,NP_8259A,T_8259A,NP_8251A,T_8251A
        ;不知道为什么，直接传递T_8255A会出错，这里使用BX来辅助
        MOV BX,T_8255A
        CH_ORI P_8255A,NP_8255A,BX,0004H,CH1
        MOV BX,T_8253
...
CH_PORT_CON MACRO NP_8255A,NP_8253,NP_8259A,NP_8251A
        CH_ORI P_8255A,NP_8255A,01H,0004H,CH_CON1
...
CH_PORT_OE MACRO NP_8255A,NP_8253,NP_8259A,NP_8251A
        CH_ORI P_8255A,NP_8255A,02H,0004H,CH_OE1
...
BEGIN:  MOV AX,DSEG
        ...
        ;CH_PORT_CON 304H,300H,312H,308H
        ;CH_PORT_OE 308H,300H,316H,310H
        ;八个参数依次是8255A、8253、8259A、8251A的端口首地址和类型
        ;端口地址和类型紧邻，01H代表连续地址，02H代表基地址或者偶地址
        ;CH_PORT 304H,01H,300H,01H,312H,02H,308H,02H

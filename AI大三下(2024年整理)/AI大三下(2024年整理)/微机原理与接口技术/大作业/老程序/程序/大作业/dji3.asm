DATAS SEGMENT
    ...
    INSTART DB 0DH,0AH,'please give me the name of start node name',0DH,0AH,'$'
    INEND DB 0DH,0AH,'please give me the name of end node name',0DH,0AH,'$'
